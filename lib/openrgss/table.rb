# The multidimensional array class. Each element is an integer of 2 signed bytes
# ranging from -32,768 to 32,767.
#
# Ruby's Array class does not run efficiently when handling large amounts of data,
# hence the inclusion of this class.
...
class Table
	...
	def self._load s #:nodoc:
		new(1).instance_eval do
			@size, @xsize, @ysize, @zsize, _, *@data = s.unpack 'LLLLLS*'
			self
		end
	end
